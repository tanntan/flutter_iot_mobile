...
class ScanList extends StatelessWidget {
  ...
  const ScanList(this.items, this.icon,
      {Key? key, this.onTap, this.disableLoading})
      : super(key: key);
  ...
  Widget _buildItem(
    ...
    return ListTile(
        ...
        title: Text(
          item['name'] ?? item['ssid'],
          style:
              TextStyle(color: Theme.of(_context).colorScheme.onSurfaceVariant),
        ),
            ...
            : SizedBox(
                child: Container(
                    ...
                    child: Align(
                        ...
                        child: SpinKitRipple(
                            color:
                                Theme.of(_context).colorScheme.onBackground)))),
        Expanded(
